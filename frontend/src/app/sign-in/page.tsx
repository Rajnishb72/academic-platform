...
import { ShieldCheck, GraduationCap, ArrowRight, Lock, Mail, AlertCircle } from 'lucide-react'
                    ...
                    <div className="mt-8">
                        <form action={login} className="space-y-6">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="group flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-indigo-500/25 transition-all hover:shadow-[0_0_24px_rgba(99,102,241,0.35)] active:scale-[0.98]"
                                >
                                    Sign in
            ...
            <div className="relative hidden w-0 flex-1 lg:block bg-slate-900 border-l border-white/[0.04] overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center text-slate-400">
                    ...
                    <p className="max-w-md text-slate-400 leading-relaxed">
                        Secure, end-to-end encrypted platform for sharing knowledge, tracking your academic journey, and supercharging your study sessions with AI.
                    </p>
                </div>
            </div>
        </div>
